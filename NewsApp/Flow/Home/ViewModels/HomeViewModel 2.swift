...
protocol HomeViewModelProtocol {
    ...
    func fetchStories(for section: String, refresh: Bool)
    func fetchMostViewedStories(refresh: Bool)
...
class HomeViewModel: HomeViewModelProtocol, ObservableObject {
    ...
    func fetchStories(for section: String, refresh: Bool = false) {
        do {
    ...
    func fetchMostViewedStories(refresh: Bool = false) {
        do {
